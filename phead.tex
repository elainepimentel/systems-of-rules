...
%\newcommand{\jUnf}[4]{#1 ; #2 \seq  #3 ; #4}% unfocused sequent
\newcommand{\jUnf}[4]{\isemp{#1}\mathbin{\Uparrow}\isemp{#2}\seq
                      \isemp{#3}\mathbin{\Uparrow}\isemp{#4}}% unfocused sequent

\newcommand{\jUnfamb}[3]{#1 \mathbin\Uparrow #2 \seq  #3 \Rscr}% unfocused sequent
%\newcommand{\jUnfG}[2]{\jUnf{\Gamma}{#1}{#2}{{\cdot}}}% unf sequ with \Gamma
\newcommand{\jUnfG}[2]{\jUnf{\Gamma}{\isemp{#1}}{\isemp{#2}}{{\cdot}}}% unf sequ with \Gamma
\newcommand{\jUnfGamb}[1]{\Gamma\mathbin\Uparrow #1\seq \Rscr}% unf sequ with \Gamma
\newcommand{\jLf}[3]{\isemp{#1}\Downarrow\isemp{#2}\seq\isemp{#3}}% left focused sequent
\newcommand{\jLCf}[3]{#1,\Cx{\Downarrow{#2}}\seq\isemp{#3}}% left focused context sequent
\newcommand{\jLfG}[1]{\jLf{\Gamma}{#1}{R}}% left foc seq with \Gamma 
\newcommand{\jRf}[2]{#1 \seq #2 \Downarrow}% right focused sequent
\newcommand{\jRCf}[3]{#1 \seq \Cx{#2 \Downarrow},#3}% right focused sequent
...
% In order to get a draft without blue sentences (for the web), we can
