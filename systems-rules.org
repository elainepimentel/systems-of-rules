...
#+BEGIN_EXAMPLE
	  ...
	  Gamma |- phi
#+END_EXAMPLE
      This rule resembles Gabbay's restart rule.  However, others have
      studied this rule earlier:  see Curry 1963 (Foundations of
      mathematical logic).  Also, Zimmermann's TCS paper in 2002 (page
      561-574). 
