...
%		
%		\begin{itemize}
%			\item<4-> \emphdb{Systematically} compute inference rules from
%			{bipolar axioms} (\emphdr{$\lambda$-Prolog prototype});
%			
%			\item<4-> \emphdr{Uniform} presentation for \emphdb{classical} and \emphdb{intuitionistic} first order systems;
%			
%			\item<4-> \emphdb{Generalization} of the literature (e.g.~on \emphdr{geometric theories} [Negri et al, Vigan\`o, Simpson]);
%			
%			\item<4> \emphdr{Cut-elimination} \emphdb{guaranteed} for
