...
\medskip
	\begin{tikzpicture}
	\node at (-1.9,2.5) {$\jUnf{\Gamma,\Gamma_1}{\cdot}{\cdot}{\Delta_1}\,\cdots\,\jUnf{\Gamma,\Gamma_n}{\cdot}{\cdot}{\Delta_n}$};
...
\only<3>{\medskip
\begin{tikzpicture}
	\node at (-1.9,2.5) {$\jUnf{\Gamma,\Gamma_1}{\cdot}{\cdot}{\Delta_1}\;\ldots\;\jUnf{\Gamma,\Gamma_n}{\cdot}{\cdot}{\Delta_n}$};
	\node at (-1.5,-1.4) {\kern -30pt\raisebox{8pt}{$(B\in\Gamma)~~$}$\infer[\kern -2pt D_l]{
			\jUnf{\Gamma}{\cdot}{\cdot}{\Delta}}{
			\jLf{\Gamma}{B}{\Delta}}$};
	...
	\node at (4,-0.5) {
		$\infer{\Gamma \seq \Delta}{\Gamma,\Gamma_1 \seq \Delta_1 \quad\ldots\quad \Gamma,\Gamma_n\seq\Delta_n}$};
\end{tikzpicture}}
\end{overlayarea}
\end{frame}
