...
\begin{frame}\frametitle{The main result [Marin, Miller, Pimentel \& Volpe]}	
...
%	\begin{block}{}
%		\textbf{Theorem 2.}
%		Let $\LK\tup{\axioms}$/$\LJ\tup{\axioms}$ denote the
...
\begin{frame}\frametitle{Example: Horn clauses as bipoles}
\only<1>{\[
