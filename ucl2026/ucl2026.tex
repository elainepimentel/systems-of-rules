...
\author[Miller, Pimentel]{
  ...
  {\small Joint work with Elaine Pimentel, UCL}
}
\date{23 April 2026}
...
\begin{tabular}{lcl}
\includegraphics[scale=0.5]{../slides/figs/gentzen1} &\qquad& \includegraphics[scale=0.3]{../slides/figs/gentzen3}\\
\includegraphics[scale=0.5]{../slides/figs/gentzen2} 
\end{tabular}
}	
\only<3>{
\begin{center}
